...
function DataModal({ show, setShow, data, modalType }) {
  ...
  const handleSave = (e) => {
    ...
    // ============================================
    // >>>>>>>>>>>>>>>>>>>>> update needed
    const addUrl = `${baseUrl}/admin/serviceproviderservicecategories/add`;
    const editUrl = `${baseUrl}/admin/serviceproviderservicecategories/update/${data.selectedId}`;
    form_data.append("name", data.name);
    form_data.append("medicalServiceCategory", data.medicalServiceCategory);
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          ...
          <Form onSubmit={handleSave}>
            ...
            {/* <Form.Group className="mb-3" controlId="formBasicEmail">
              <Form.Label>medicalServiceCategory</Form.Label>
              ...
              hidden
              name=""
              value={data.medicalServiceCategory}
              onChange={(e) => {
                data.setmedicalServiceCategory(e.target.value);
              }}
            ...
            />
              ...
              >
                ...
                {data.allMedicalServices.map((value2, index2) => {
                  return (
